...
{
    clcd_putch( '0'+(((adc_val*99)/1023)/10) ,(0xC0 + (14)));
    clcd_putch( '0'+(((adc_val*99)/1023)%10) ,(0xC0 + (15)));
}
...
# 153 "main.c"
 ...
 display_gear(key);
 display_time();
 display_speed( adc_val = read_adc(0x04) );
